...
--------------------------------------------------------------
		do
			G.UnitFrames["Boss" .. i].Health:Size( 200, 20 )
...
--------------------------------------------------------------
		do
			G.UnitFrames["Boss" .. i].Power:Size( 200, 3 )
...
---------------------------------------------------------------
		do
			if( C["unitframes"].unitcastbar == true ) then
				...
				G.UnitFrames["Boss" .. i].Castbar:SetHeight( 15 )
				G.UnitFrames["Boss" .. i].Castbar:Point( "TOPRIGHT", G.UnitFrames["Boss" .. i], "BOTTOMRIGHT", 0, -10 )
				...
				if( C["unitframes"].cbicons == true ) then
					...
					G.UnitFrames["Boss" .. i].Castbar.button:Size( 19)
				else
...
--------------------------------------------------------------
		...
		------------------------------
		do
			G.UnitFrames["Boss" .. i]:Size( 200, 20 )
		end
	end
end