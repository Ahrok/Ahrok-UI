...
--------------------------------------------------------------
		do
			G.UnitFrames["Arena" .. i].Health:Size( 200, 20 )
...
--------------------------------------------------------------
		do
			G.UnitFrames["Arena" .. i].Power:Size( 200, 3 )
...
--------------------------------------------------------------
		do
			if( C["unitframes"].unitcastbar == true ) then
				...
				G.UnitFrames["Arena" .. i].Castbar:SetHeight( 15 )
				G.UnitFrames["Arena" .. i].Castbar:Point( "TOPRIGHT", G.UnitFrames["Arena" .. i], "BOTTOMRIGHT", 0, -10 )
				...
				if( C["unitframes"].cbicons == true ) then
					...
					G.UnitFrames["Arena" .. i].Castbar.button:Size( 19 )
				else
		...
		do
			...
			G.UnitFrames["Arena" .. i].PVPSpecIcon:Size(20)
...
--------------------------------------------------------------
		do
			...
			G.UnitFrames["Arena" .. i].Trinket:Size(20)
		end
		...
		------------------------------
		do
			G.UnitFrames["Arena" .. i]:Size( 200, 20 )
		end
	end
end